...
public class DataTypeExamples {
    ...
    /**
     * Método que prueba o testea la LinkedList con  enteros o int
     * Creo una lista y los inserto al final de la misma, tambien se muestran en consola
    */
    ...
    /**
     * Método que prueba la LinkedList (el mismo que el anterior pero ahora prueba con Strings)
    ...
    */
    ...
    /**
     * Método que prueba la LinkedList con objetos pero ahora complejos, los contactos que pide la Actividad
     * Creo varios contactos (10 para ser exactos), los inserto al final de la lista y muestra la lista en consola
     */
    public static void testComplexObjects() {
        /**
        * Creo varios contactos (10 para ser exactos), los inserto al final de la lista y muestra la lista en consola
        */
